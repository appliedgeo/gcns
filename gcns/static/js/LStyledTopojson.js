...
// get color depending on frost value
		function getColor(d) {
			return d > 5 ? '#9900FF' :
			       d > 4  ? '#FF99CC' :
			       d > 3   ? '#FF0000' :
		...
		function symbolise(feature) {
			return {
				...
				//dashArray: '3',
				fillOpacity: 0.7,
				fillColor: getColor(feature.properties.frost)
			};
		}
